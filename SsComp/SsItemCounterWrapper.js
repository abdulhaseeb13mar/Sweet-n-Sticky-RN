...
import {SsaddCartAction, SsremoveCartAction} from '../SsRedux/SsActions';
    ...
    <View
      ...
      {(position === 'top' || position === 'left') && (
        <DefaultCounter
          position={position}
          item={props.item}
          SsGoToSingleProduct={props.SsGoToSingleProduct}
  ...
  return (
    <View
      ...
      <View
        ...
        <TouchableOpacity onPress={() => SsremoveCart(item)}>
          <Feather
            name="minus-circle"
            size={H_W.width * 0.05}
...
export default connect(null, {SsaddCartAction, SsremoveCartAction})(
  ItemCounterWrapper,
);
