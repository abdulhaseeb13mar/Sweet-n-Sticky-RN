...
const SsCartReducer = (st = cart, action) => {
...
const SsUserReducer = (st = userState, action) => {
  switch (action.type) {
...
const SsCrntPrdtReducer = (state = crntPrdtState, action) => {
  switch (action.type) {
...
const SsToggleFav = (state = FavItems, action) => {
  switch (action.type) {
